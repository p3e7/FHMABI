...
%%%% --- Sprache ---
   english,
   ngerman,           % Letzte Sprache ist die Hauptsprache, andere muss erst ausgewÃ¤hlt werden.
%%%% === SeitengrÃ¶Ãe ===
   a4paper,
%%%% === Optionen fÃ¼r den Satzspiegel ===
...
%%%% === Layout ===
   ...
   %twoside,         % Seitenraender fÃ¼r zweiseitiges Layout
...
%%%% --- Absatzeinzug ---
   ...
   %parindent,       % EingerÃ¼ckt (Standard)
%%%% --- Kolumnentitel ---
...
%%%% === Verzeichnisse (TOC, LOF, LOT, BIB) ===
   ...
   %pointednumbers,  % Ãberschriftnummerierung mit Punkt, siehe DUDEN !
   %pointlessnumbers, % Ãberschriftnummerierung ohne Punkt, siehe DUDEN !
...
\begin{document}
  ...
  \linespread {1.25}\selectfont %Zeilenabstand: 1.25 da er von Haus aus 1.2 ist und 1,25 * 1,2 = 1,5
    ...
    \input{inhalt/hintergrund}
    \input{inhalt/sap}
	%\input{inhalt/modellierung}
	%\input{inhalt/monitoring}
	%\input{inhalt/bc}
	%\input{inhalt/metaRepo}   
    %\input{inhalt/administration}
    %\input{inhalt/ende}
...
%	\listoftables
	...
	%\input{inhalt/anhang}
	%\input{inhalt/eidesstattliche_erklaerung}
\end{document}
